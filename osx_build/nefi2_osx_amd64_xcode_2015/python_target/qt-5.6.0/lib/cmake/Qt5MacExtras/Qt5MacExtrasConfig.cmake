...
set(Qt5MacExtras_VERSION_STRING 5.6.0)
...
if (NOT TARGET Qt5::MacExtras)
    ...
    set(_Qt5MacExtras_OWN_INCLUDE_DIRS "${_qt5MacExtras_install_prefix}/include/" "${_qt5MacExtras_install_prefix}/include/QtMacExtras")
    set(Qt5MacExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5MacExtras_install_prefix}/include/QtMacExtras/5.6.0"
        "${_qt5MacExtras_install_prefix}/include/QtMacExtras/5.6.0/QtMacExtras"
    )
    ...
    foreach(_module_dep ${_Qt5MacExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt5MacExtras_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::MacExtras STATIC IMPORTED)
    set_property(TARGET Qt5::MacExtras PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_MacExtras_target_properties(RELEASE "libQt5MacExtras.a" "" )
