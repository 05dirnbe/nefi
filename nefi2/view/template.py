...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.DynamicUiElements = QtWidgets.QWidget(self.RightView)
        self.DynamicUiElements.setMinimumSize(QtCore.QSize(250, 300))
        self.DynamicUiElements.setAutoFillBackground(False)
        self.DynamicUiElements.setObjectName("DynamicUiElements")
        self.verticalLayout.addWidget(self.DynamicUiElements)
        spacerItem1 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout.addItem(spacerItem1)
        self.Pipeline = QtWidgets.QWidget(self.RightView)
        self.Pipeline.setMinimumSize(QtCore.QSize(250, 300))
        self.Pipeline.setMaximumSize(QtCore.QSize(250, 300))
        self.Pipeline.setObjectName("Pipeline")
        self.verticalLayout.addWidget(self.Pipeline)
