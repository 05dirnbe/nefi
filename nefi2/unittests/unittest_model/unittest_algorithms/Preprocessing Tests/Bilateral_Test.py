...
class TestBilateral(unittest.TestCase):
    ...
    def test_instantiation(self):
      ...
      self.assertEqual(len(obj.float_sliders), 2)
      self.assertEqual(obj.name, "Bilateral Filter")
      self.assertEqual(obj.parent, "Preprocessing")
      self.assertEqual(obj.integer_sliders[0].name, "diameter")
      ...
      self.assertEqual(obj.float_sliders[0].name, "sigmaColor")
      self.assertEqual(obj.float_sliders[0].lower, 0.0)
      self.assertEqual(obj.float_sliders[0].upper, 255.0)
      self.assertEqual(obj.float_sliders[0].step_size, 0.1)
      self.assertEqual(obj.float_sliders[0].value, 30.0)

      self.assertEqual(obj.float_sliders[1].name, "sigmaSpace")
      self.assertEqual(obj.float_sliders[1].lower, 0.0)
      self.assertEqual(obj.float_sliders[1].upper, 255.0)
      self.assertEqual(obj.float_sliders[1].step_size, 0.1)
      self.assertEqual(obj.float_sliders[1].value, 30.0)
    ...
    def test_slider_setter(self):
      ...
      self.assertEqual(obj.diameter.value, 5)
      obj.integer_sliders[0].set_value(10)
      self.assertEqual(obj.integer_sliders[0].value, 10)
      self.assertEqual(obj.diameter.value, 10)

      obj.float_sliders[0].set_value(80.0)
      self.assertEqual(obj.float_sliders[0].value, 80.0)
      self.assertEqual(obj.sigma_color.value, 80.0)
      obj.float_sliders[0].set_value(90.0)
      self.assertEqual(obj.float_sliders[0].value, 90.0)
      self.assertEqual(obj.sigma_color.value, 90.0)

      obj.float_sliders[1].set_value(80.0)
      self.assertEqual(obj.float_sliders[1].value, 80.0)
      self.assertEqual(obj.sigma_space.value, 80.0)
      obj.float_sliders[1].set_value(90.0)
      self.assertEqual(obj.float_sliders[1].value, 90.0)
      self.assertEqual(obj.sigma_space.value, 90.0)
    ...
    def test_process_separate_channels(self):
      ...
      channels_ref = [cv2.bilateralFilter(channels_original[0], 3, 30.0, 30.0),
                      cv2.bilateralFilter(channels_original[1], 3, 30.0, 30.0),
                      cv2.bilateralFilter(channels_original[2], 3, 30.0, 30.0)]
