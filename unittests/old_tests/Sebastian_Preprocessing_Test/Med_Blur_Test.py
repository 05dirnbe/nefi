...
import numpy as np
from Sebastian_Algorithms_untested.med_blur import *
import cv2
import unittest
...
class TestMedianBlur(unittest.TestCase):
  ...
  def test_instantiation(self):
    ...
    self.assertEqual(obj.name, "Median Blur")
  ...
  def test_process_whole_channels(self):
    ...
    ref_image1 = cv2.medianBlur(test_image, 3)
    ref_image2 = cv2.medianBlur(test_image, 11)
  ...
  def test_process_seperate_channels(self):
    obj1 = AlgBody()
    obj2 = AlgBody()
    obj3 = AlgBody()
    obj4 = AlgBody()
